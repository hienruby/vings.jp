...
恐れ入りますがお問い合わせページよりお問い合わせください。',
    ...
    'admin.cart_analytics.search.error.date' => '集計期間は31日以下にしてください。',
    ...
    'admin.introduce_discount.notfound' => 'データが存在しません。',
    'admin.plugin.introduce_discount.regist.success' => 'データが正常に登録できました。',
