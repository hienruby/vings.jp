...
if (!function_exists('kcfinderAutoload')) {
...
define('HTML_REALDIR', realpath(dirname(__FILE__)).'/../../../../');
...
$disabled = empty($_SESSION['member_id']);
...
$_CONFIG = array(
    ...
    'uploadURL' => HTTP_URL . "upload/mail_image",
    'uploadDir' => HTML_REALDIR . "upload/mail_image/",
